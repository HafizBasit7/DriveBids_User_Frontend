  ...
  return (
    ...
    >
      ...
      <DamageReportBox
        ...
        description="Please select the appropriate damage label and place it on the damaged area on the left side of the car. If there's no damage, proceed to the next step."
        carFacing={2}
