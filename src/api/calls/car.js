...
export const getDrafts = async (page = 1, limit = 10) => {
  try {
    const result = await apiClient.get(
      `/car/drafts?page=${page}&limit=${limit}`
    );
...
export const listCars = async (
  ...
  try {
    const result = await apiClient.get(
      `/car/list?page=${page}&limit=${limit}&type=${type}&lng=${lng}&lat=${lat}`
    );
    const resultData = result.data;
...
export const listCarsByBidCount = async (page = 1, limit = 10, lng, lat) => {
  try {
    const result = await apiClient.get(
      `/car/listByBidCount?page=${page}&limit=${limit}&lng=${lng}&lat=${lat}`
    );
    const resultData = result.data;
...
export const listMyAds = async (page = 1, limit = 10) => {
  try {
    const result = await apiClient.get(
      `/car/myAds?page=${page}&limit=${limit}`
    );
    const resultData = result.data;
...
export const listMyBids = async (page = 1, limit = 10, type = "open") => {
  try {
    const result = await apiClient.get(
      `/car/myBids?page=${page}&limit=${limit}&type=${type}`
    );
    const resultData = result.data;
...
export const getCarOwnerCars = async (page = 1, limit = 10, userId) => {
  try {
    const result = await apiClient.get(
      `/car/getCarOwnerCars/${userId}?page=${page}&limit=${limit}`
    );
    const resultData = result.data;
...
export const getSimilarCars = async (page = 1, limit = 10, make) => {
  try {
    const result = await apiClient.get(
      `/car/getSimilarCars/${make}?page=${page}&limit=${limit}`
    );
    const resultData = result.data;
...
export const searchCars = async (
  ...
  try {
    ...
    const result = await apiClient.get(
      `/car/searchCars?page=${page}&limit=${limit}&${queryString}&lng=${lng}&lat=${lat}`
    );
    const resultData = result.data;
...
export const getCompletedDeals = async (page = 1, limit = 10, type = "buy") => {
  try {
    const result = await apiClient.get(
      `/car/completedDeals?page=${page}&limit=${limit}&type=${type}`
    );
    const resultData = result.data;
